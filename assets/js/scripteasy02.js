...
function verificar() {
    ...
    if (document.getElementById("opcaoA").checked && opA == true) {
        ...
        document.getElementById('justificativa').innerHTML = `Errado, a alternativa correta é a letra E. Justificativa: Demoramos para chegar na praia, pois estava muito trânsito. O “pois” é uma conjunção coordenativa explicativa, e não adversativa. Ela é usada para explicar ou justificar algo. <br>Nas outras alternativas, todas possuem uma conjunção coordenativa adversativa: a) mas b) porém c) no entanto d) contudo`
        ...
        exerciseBox.style.height = '490px'
        justificar.style.textAlign = "center"
        pontuacao = pontuacao + 5
    }
